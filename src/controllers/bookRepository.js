...
var BooksRepository = /** @class */ (function () {
    ...
    BooksRepository.prototype.createBook = function (book) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, bookModel_1.default.create(book)];
                    case 1:
                        newBook = _a.sent();
    ...
    BooksRepository.prototype.getBook = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, bookModel_1.default.find({ 'id': id })];
                    case 1:
                        book = _a.sent();
    ...
    BooksRepository.prototype.updateBook = function (book) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, bookModel_1.default.updateOne({ id: book.id }, {
                            title: book.title,
    ...
    BooksRepository.prototype.deleteBook = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, bookModel_1.default.deleteOne({ id: id })];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result];
                }
    ...
    ;
    BooksRepository.prototype.downloadBook = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var books;
            return __generator(this, function (_a) {
                switch (_a.label) {
